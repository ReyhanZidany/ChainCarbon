              ...
              <div className="mt-2 bg-white border rounded-lg shadow-lg">
                {categories.map((cat) => (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-semibold border-b last:border-b-0 ${activeCategory === cat.id ? 'bg-emerald-50 text-emerald-600' : 'text-gray-700'
                      }`}
                  >
          ...
          <div className="hidden lg:flex flex-wrap gap-4 items-center mb-5">
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`flex items-center gap-2.5 px-6 py-3 rounded-xl font-semibold text-base transition-all ${activeCategory === cat.id
          ...
          <div className="flex items-start gap-4 flex-wrap mb-5">
            ...
            <div className="flex flex-wrap gap-3 flex-1 overflow-x-auto pb-2 sm:pb-0 scrollbar-hide">
              <button
                ...
                className={`px-6 py-2.5 rounded-full font-semibold text-base transition-all whitespace-nowrap ${selectedSubCategory === "all"
              ...
              return (
                ...
                >
                  <div className="relative overflow-hidden">
                    ...
                    <button
                      className={`absolute top-4 right-4 p-3 rounded-full backdrop-blur-sm transition-all ${isInWishlist(p.id)
            ...
            {filteredProjects.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    className={`p-5 m-5 rounded-full self-start transition-all ${isInWishlist(p.id)
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4 sm:pt-6 border-t-2 sticky bottom-0 bg-white -mx-4 sm:mx-0 px-4 sm:px-0 pb-4 sm:pb-0">
                {selectedProject.isOwner ? (
                  ...
                  <>
                    ...
                    <button
                      className={`px-6 py-3 sm:py-4 rounded-xl font-semibold border-2 transition-all flex items-center justify-center gap-2 text-sm sm:text-base ${isInWishlist(selectedProject.id)
